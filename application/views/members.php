...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="#" data-toggle="modal" data-target="#unitModal" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> New Member</a>
    </div>
                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- edit -->
                                <a href="#" data-toggle="modal" data-target="#memberModal<?php echo $m->id ?>" class="btn btn-sm btn-info btn-icon-split mb-2">
                                ...
                                <!-- delete -->
                                <!-- edit -->
                                <a href="#" data-toggle="modal" data-target="#dropMemberModal<?php echo $m->id ?>" class="btn btn-sm btn-danger btn-icon-split mb-2">
                                    <span class="icon text-white-50">
...
<!-- Members Modal -->
<?php foreach($members as $m): ?>
<div class="modal fade" id="memberModal<?php echo $m->id ?>" tabindex="-1" role="dialog" aria-labelledby="memberModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" id="member_id" value="<?php echo $m->id ?>" name="member_id">
                ...
                <div class="form-group">
                    ...
                    <select name="unit_id" id="unit_id" class="form-control">
                        ...
                        <option value="<?php echo $u->id ?>"><?php echo $u->number ?></option>
                        <?php endforeach ?>
                    </select>
                </div>
                <div class="form-group">
...
<div class="modal fade" id="dropMemberModal<?php echo $m->id ?>" tabindex="-1" role="dialog" aria-labelledby="memberModalLabel" aria-hidden="true">
